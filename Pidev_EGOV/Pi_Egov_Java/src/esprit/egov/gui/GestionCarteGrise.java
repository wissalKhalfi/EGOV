 ...
 * @author macbookpro
 */
public class GestionCarteGrise extends javax.swing.JFrame {

    /**
     * Creates new form GestionEn
     */
    public GestionCarteGrise() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        AddEN.setText("Ajouter Carte Grise");
        ...
        ShowEN.setText("Affiicher Carte Grise");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(ShowEN, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(17, 17, 17)
    ...
    private void AddENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddENActionPerformed
        AddCarteGrise add=new AddCarteGrise ();
        add.setVisible(true);
    ...
    private void MajENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MajENActionPerformed
       UpdateCarteGrise add=new UpdateCarteGrise();
        add.setVisible(true);
        this.setVisible(false);
    ...
    private void ShowENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ShowENActionPerformed
       showCarteGrise add=new showCarteGrise ();
        add.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionCarteGrise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionCarteGrise().setVisible(true);
            }
        });
    }
