 ...
 * @author macbookpro
 */
public class UpdateCandidature extends javax.swing.JFrame {

    /**
     * Creates new form Acceuil
     */
    public UpdateCandidature() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCandidature.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCandidature().setVisible(true);
            }
        });
    }
