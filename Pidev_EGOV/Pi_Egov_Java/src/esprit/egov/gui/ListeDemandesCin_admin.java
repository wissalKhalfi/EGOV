 ...
 * @author macbookpro
 */
public class ListeDemandesCin_admin extends javax.swing.JFrame {

    /**
     * Creates new form ListeDemandesCin_admin
     */
    void updateTable() {
        DefaultTableModel model = (DefaultTableModel) DemandesCin.getModel();
        model.setRowCount(0);
        IUtilisateurDao utiDao = new UtilisateurDao();
        List<Utilisateur> listeCin = utiDao.ListerDemandesCin();
        for (Utilisateur ind : listeCin) {
            model.addRow(
                    new Object[]{ind.getIduti(), ind.getNom(), ind.getPrenom(), ind.getDateNaissance(), ind.getLieuNaissance(), ind.getNomPere(), ind.getPrenomPere(), ind.getNomMere(), ind.getPrenomMere(), ind.getSexe(), ind.getStatutSocial(), ind.getAdresse(), ind.getProfession()
                    }
            );
        }
    }

    public ListeDemandesCin_admin() {
        initComponents();
        updateTable();
    }
    ...
    private void initComponents() {
        ...
        DemandesCin.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nom", "Prenom", "Date de naissance", "Lieu de naissance", "Nom Pere", "Prenom Pere", "Nom mere", "Prenom Mere", "Sexe", "Statut social", "Adresse", "Profession"
            }
        ));
        ...
        Accepter.setForeground(new java.awt.Color(0, 204, 102));
        Accepter.setIcon(new javax.swing.ImageIcon("/Users/macbookpro/Desktop/3A13/PiDev/JavaSprint/Pi_Egov/images/ok.png")); // NOI18N
        ...
        Refuser.setForeground(new java.awt.Color(255, 51, 0));
        Refuser.setIcon(new javax.swing.ImageIcon("/Users/macbookpro/Desktop/3A13/PiDev/JavaSprint/Pi_Egov/images/No.png")); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(photoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(3, 3, 3)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void RefuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefuserActionPerformed
        ...
        int retour = d.showConfirmDialog(this, "Refuser la demande?", "confirmer refus Cin", JOptionPane.OK_CANCEL_OPTION);
        if (retour == 0) {
            int row = DemandesCin.getSelectedRow();
            int id = Integer.parseInt(DemandesCin.getModel().getValueAt(row, 0).toString());
            IUtilisateurDao utiDao = new UtilisateurDao();
            utiDao.RefuserDemandeCin(id);
            updateTable();
        }
    ...
    private void DemandesCinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DemandesCinMouseClicked
        int row = DemandesCin.getSelectedRow();
        String nom = (DemandesCin.getModel().getValueAt(row, 1).toString());
        Nom.setText(nom);
        String pnom = (DemandesCin.getModel().getValueAt(row, 2).toString());
        Prenom.setText(pnom);
        Date dateNaiss = (Date) DemandesCin.getModel().getValueAt(row, 3);
        DateNaiss.setDate(dateNaiss);
        String Lieu = (DemandesCin.getModel().getValueAt(row, 4).toString());
        LieuNaiss.setText(Lieu);
        String nomP = (DemandesCin.getModel().getValueAt(row, 5).toString());
        NomPére.setText(nomP);
        String pnomP = (DemandesCin.getModel().getValueAt(row, 6).toString());
        PrenomPére.setText(pnomP);
        String nomM = (DemandesCin.getModel().getValueAt(row, 7).toString());
        NomMère.setText(nomM);
        String pnomM = (DemandesCin.getModel().getValueAt(row, 8).toString());
        PrenomMère1.setText(pnomM);
        String sexe = (DemandesCin.getModel().getValueAt(row, 9).toString());
        ...
        String statutSocial = DemandesCin.getModel().getValueAt(row, 10).toString();
        statutsocial.setText(statutSocial);
        String adr = DemandesCin.getModel().getValueAt(row, 11).toString();
        Adresse.setText(adr);
        String prof = DemandesCin.getModel().getValueAt(row, 12).toString();
    ...
    private void ImprimerlisteDemENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImprimerlisteDemENActionPerformed
        ...
        MessageFormat header = new MessageFormat("Liste de demandes de cartes d'identités nationales");
        MessageFormat footer = new MessageFormat("Page{0,number,integer}");
        try {
            DemandesCin.print(JTable.PrintMode.NORMAL, header, footer);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeDemandesCin_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeDemandesCin_admin().setVisible(true);
            }
        });
    }
