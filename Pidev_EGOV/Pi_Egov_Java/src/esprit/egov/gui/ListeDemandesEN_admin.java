 ...
 * @author macbookpro
 */
public class ListeDemandesEN_admin extends javax.swing.JFrame {
    ...
    DefaultTableModel model = (DefaultTableModel) DemandesEN.getModel();
        ...
        List<Utilisateur> listeEN =utiDao.ListerDemandesEN();
    ...
    public ListeDemandesEN_admin() {
       ...
       /* DefaultTableModel model = (DefaultTableModel) DemandesEN.getModel();
        ...
        DemandesEN.getColumn("Valider").setCellRenderer();
        DemandesEN.getColumn("Valider").setCellEditor(new ButtonEditor(new JCheckBox()));*/
    ...
    private void initComponents() {
        ...
        DemandesEN.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DemandesENMouseClicked(evt);
            }
        });
    ...
    private void RefuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RefuserActionPerformed
     ...
     int retour = d.showConfirmDialog(this, "Refuser la demande?",  "confirmer refus EN", JOptionPane.OK_CANCEL_OPTION);
     if(retour==0){
       int row= DemandesEN.getSelectedRow();
       int id= Integer.parseInt( DemandesEN.getModel().getValueAt(row, 0).toString() );       
       IUtilisateurDao utiDao = new UtilisateurDao() ;
        utiDao.RefuserDemandeEN(id);       
        updateTable();
     }
    }//GEN-LAST:event_RefuserActionPerformed

    private void DemandesENMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DemandesENMouseClicked
       int row= DemandesEN.getSelectedRow();
       String nom= (DemandesEN.getModel().getValueAt(row, 1).toString());
       Nom.setText(nom);
       String pnom= (DemandesEN.getModel().getValueAt(row, 2).toString());
       Prenom.setText(pnom);
       String Lieu= (DemandesEN.getModel().getValueAt(row, 4).toString());
       LieuNaiss.setText(Lieu);
       String nomP= (DemandesEN.getModel().getValueAt(row, 5).toString());
       NomPére.setText(nomP);
       String pnomP= (DemandesEN.getModel().getValueAt(row, 6).toString());
       PrenomPére.setText(pnomP);
       String nomM= (DemandesEN.getModel().getValueAt(row, 7).toString());
       NomMère.setText(nomM);
       String pnomM= (DemandesEN.getModel().getValueAt(row, 8).toString());
       PrenomMère1.setText(pnomM);
       String sexe= (DemandesEN.getModel().getValueAt(row, 9).toString());       
       if (sexe=="Feminin" || sexe=="feminin") {
    ...
    }//GEN-LAST:event_DemandesENMouseClicked
    ...
    private void ImprimerlisteDemENActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ImprimerlisteDemENActionPerformed
        ...
        MessageFormat header= new MessageFormat("Liste de dmandes d'extraits de naissance");
        MessageFormat footer= new MessageFormat("Page{0,number,integer}");
        try{
           DemandesEN.print(JTable.PrintMode.NORMAL, header, footer);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeDemandesEN_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeDemandesEN_admin().setVisible(true);
            }
        });
    }
