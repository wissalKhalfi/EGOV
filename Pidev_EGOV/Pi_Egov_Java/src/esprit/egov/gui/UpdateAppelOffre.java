 ...
 * @author macbookpro
 */
public class UpdateAppelOffre extends javax.swing.JFrame {

    /**
     * Creates new form Acceuil
     */
    public UpdateAppelOffre() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAppelOffre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateAppelOffre().setVisible(true);
            }
        });
    }
