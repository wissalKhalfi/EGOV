 ...
 * @author macbookpro
 */
public class GestionEroute extends javax.swing.JFrame {

    /**
     * Creates new form GestionEn
     */
    public GestionEroute() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionEroute.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionEroute().setVisible(true);
            }
        });
    }
