 ...
 * @author macbookpro
 */
public class ShowB3 extends javax.swing.JFrame {
    ...
    DefaultTableModel model = (DefaultTableModel) ListeActeJuri.getModel();
        ...
        IListeActesDao listeActeDao = new ListeActesDao ();
         List<ListeActes> listeEN =listeActeDao.TrouverActesParCitoyen(numCin);
        for (ListeActes ind : listeEN) {
            ActesJuridiques Acte=ind.getActe();
            model.addRow(
                    new Object[]{Acte.getIdActe(),Acte.getTitreActe(),Acte.getDateActe(),Acte.getDescActe()
                    }
        ...
        ENLayout.setHorizontalGroup(
            ...
            .addGroup(ENLayout.createSequentialGroup()
                .addGroup(ENLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(ENLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(photoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(92, 92, 92)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ENLayout.createSequentialGroup()
                                .addGroup(ENLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(ENLayout.createSequentialGroup()
                                        ...
                                        .addGap(38, 38, 38))
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, ENLayout.createSequentialGroup()
                                        .addGap(40, 40, 40)
    ...
    private void TrouverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TrouverActionPerformed
        ...
        updateTable(NumCinRech.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowB3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
