 ...
 * @author macbookpro
 */
public class UpdateEN extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
