 ...
 * @author boumaiza
 */
public class ContratMariageListeAdmin extends javax.swing.JFrame {

    /**
     * Creates new form PasseportListeAdmin
     */
    public ContratMariageListeAdmin() {
        initComponents();
    }
...
//        Passeport arr= new Passeport();
//
//        try {
//            PasseportDao dao=new  PasseportDao();
//             List<Passeport> arrs = new ArrayList<Passeport>();
//            arrs= dao.DisplayAllPasseport();
//            PdfWriter.getInstance(document, new FileOutputStream("les passeports.pdf"));
//            System.out.println("document instancie");
//            document.open();
//            System.out.println("document open");
//            arr=dao.getBynumCinUtilisateur(id);
//            Paragraph para = new Paragraph(String.valueOf(arr.getCouleurYeux()));
//            
//                
//            document.add(para);
//            
...
//      
    ...
    private void initComponents() {
        ...
        jList1.setModel(new listeContratMariageAdmin());
        ...
        jTextFieldRechCl.setText("entrez ID du Contrat");
        jTextFieldRechCl.setOpaque(false);
    ...
    private void jButtonSupPermisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSupPermisActionPerformed
        ...
        if (!jTextFieldRechCl.getText().equals("")) {
            listeContratMariageAdmin.SupprimerContratMariage(jList1.getSelectedRow());
            System.out.println("test from if recher");
        }
        jList1.setModel(new listeContratMariage());
    ...
    private void jButtonRechercheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRechercheActionPerformed
        // TODO add your handling code here:
        if (!jTextFieldRechCl.getText().equals("")) {
            jList1.setModel(new listeContratMariageRechercher(Integer.parseInt(jTextFieldRechCl.getText())));
...
public void pdf(int id) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContratMariageListeAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContratMariageListeAdmin().setVisible(true);
            }
        });
    }
