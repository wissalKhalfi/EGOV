 ...
 * @author macbookpro
 */
public class AddAttestationResidence extends javax.swing.JFrame {

    /**
     * Creates new form AddEN
     */
    public AddAttestationResidence() {
        initComponents();
    }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tfmail, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
    ...
    private void validerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validerActionPerformed
        Utilisateur uti = new Utilisateur();
            if (Nom.getText().isEmpty()||Prenom.getText().isEmpty()||LieuNaiss.getText().isEmpty()||NomMère.getText().isEmpty()||NomPére.getText().isEmpty()||PrenomMère.getText().isEmpty() ){
        ...
        utiDao.addAttestaionResidence(uti);
        try {
            new SendMail(tfmail.getText(),"Ajout Attestation Residence","Attestation Residence ajoutée avec succes !");
        } catch (AddressException ex) {
            Logger.getLogger(AddAttestationResidence.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddAttestationResidence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddAttestationResidence().setVisible(true);
            }
        });
    }
