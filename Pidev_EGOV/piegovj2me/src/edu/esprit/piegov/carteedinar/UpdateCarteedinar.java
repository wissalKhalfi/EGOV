 ...
 * @author USER
 */
public class UpdateCarteedinar extends Form implements CommandListener,Runnable, ItemStateListener{
    CarteEdinar carteinsatance;
    ...
    String url="";
    url = "http://localhost/piegov/UpdateCarteEdinar.php";
        try {
//            ?offre_nom=test&offre_description=test&offre_prix=10&offre_reference=14
            url += "?num_carte="+ListeCartes.num_carte;
            url += "&code_carte="+code_carte.getString().trim() ;
