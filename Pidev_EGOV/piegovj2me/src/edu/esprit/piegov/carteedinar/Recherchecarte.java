 ...
 * @author USER
 */
public class Recherchecarte extends Form implements CommandListener{
       HttpConnection http;
    ...
    public Recherchecarte() {
        super("Recherche Carte");
       append(CritereTF);
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == rechercherCmd){
            ...
            {
              utils.StaticMidlet.disp.setCurrent(new ListeCartes(Integer.parseInt(CritereTF.getString())));
            }}
        }
