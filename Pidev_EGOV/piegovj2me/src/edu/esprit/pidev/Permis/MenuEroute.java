 ...
 * @author damine
 */
public class MenuEroute extends Canvas {
    
    String slector = "";
    int w, h;
    private String[] arrMenu = new String[]{"Gestion Permis", "Gestion Carte Grise","statistique Categorie","satistique carte"};
    ...
    public MenuEroute() {
        ...
        h = getHeight();
        try {
           // img = Image.createImage("/com/esprit/mooc/ressources/splash.png");
...
//header
    ...
    protected void keyPressed(int keyCode) {
        ...
        if (getGameAction(keyCode) == DOWN) {
            ...
            if (kursor == 0) {
               Midlet.INSTANCE.disp.setCurrent(new SplashScreen(Midlet.INSTANCE)
               );
            }
             if (kursor == 1) {
                Midlet.INSTANCE.disp.setCurrent(new GestionCarteGrise());
            }
              if (kursor == 2) {
