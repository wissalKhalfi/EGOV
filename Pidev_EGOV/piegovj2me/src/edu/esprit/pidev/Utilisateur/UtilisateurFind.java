 ...
 * @author macbookpro
 */
public class UtilisateurFind  extends Form implements CommandListener {
        HttpConnection http;
    DataInputStream dataStream;
    
    Command rechercherCmd = new Command("Rechercher", Command.SCREEN, 3);
    Command precedent = new Command("Retour", Command.EXIT, 0);
    TextField CritereTF = new TextField("Type:", null, 1000, TextField.INITIAL_CAPS_WORD);
    
    public UtilisateurFind() {
        super("Recherche citoyens");
        append(CritereTF);
    ...
    public void commandAction(Command c, Displayable d) {
         if (c == rechercherCmd){
            ...
            {
                  utils.StaticMidlet.disp.setCurrent(new UtilisateurTriCin(CritereTF.getString()));
